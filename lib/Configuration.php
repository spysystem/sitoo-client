...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.mysitoo.com/v2/accounts/1500';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.0.2.1/PHP';
    ...
    {
        $report  = 'PHP SDK (Spy\SitooClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.2.1' . PHP_EOL;

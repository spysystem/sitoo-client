...
/**
 * ShipmentRead Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return ShipmentReadModelFields
      */
    public static function GetModelFields(): ShipmentReadModelFields
    {
        return new ShipmentReadModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return ShipmentReadModelAttributes
      */
    public static function GetModelAttributes(): ShipmentReadModelAttributes
    {
        return new ShipmentReadModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment-read';
    ...
    protected static $openAPITypes = [
        ...
        'shipmentpackages' => '\Spy\SitooClient\Model\ShipmentpackageRead[]',
        'shipmentitems' => '\Spy\SitooClient\Model\ShipmentitemRead[]'
    ];
    ...
    protected static $setters = [
        ...
        'datenew' => 'setDatenew',
        'dateintransit' => 'setDateintransit',
    ...
    protected static $getters = [
        ...
        'datenew' => 'getDatenew',
        'dateintransit' => 'getDateintransit',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('datenew', $data ?? [], null);
        $this->setIfExists('dateintransit', $data ?? [], null);
        $this->setIfExists('datereceived', $data ?? [], null);
    ...
    */
     ...
     * Sets shipmentid
     *
     * @param int|null $shipmentid ID of shipment in Sitoo.
     *
     * @return self
     */
    ...
    {
        return $this->container['datenew'];
    }

    /**
     * Sets datenew
     *
     * @param int|null $datenew The date and time when the shipment was created.
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getDateintransit()
    {
        return $this->container['dateintransit'];
    }

    /**
     * Sets dateintransit
     *
     * @param int|null $dateintransit The date and time when the shipment was set to shipmentstate InTransit. (If null, the state has never been set)
     *
     * @return self
     */
    ...
    {
        return $this->container['datereceived'];
    }

    /**
     * Sets datereceived
     *
     * @param int|null $datereceived The date and time when the shipment was set to shipmentstate Received. (If null, the state has never been set)
     *
     * @return self
     */
     ...
     * Sets datecancelled
     *
     * @param int|null $datecancelled The date and time when the shipment was set to shipmentstate Cancelled. (If null, the state has never been set)
     *
     * @return self
     */
     ...
     *
     * @return \Spy\SitooClient\Model\ShipmentpackageRead[]|null
     */
     ...
     *
     * @param \Spy\SitooClient\Model\ShipmentpackageRead[]|null $shipmentpackages The packages in this shipment. An array of shipmentpackage.
     *
     * @return self
     */
     ...
     * Gets shipmentitems
     *
     * @return \Spy\SitooClient\Model\ShipmentitemRead[]|null
     */
     ...
     * Sets shipmentitems
     *
     * @param \Spy\SitooClient\Model\ShipmentitemRead[]|null $shipmentitems The items in this shipment. An array of shipmentitem.
     *
     * @return self
     */

...
/**
 * GetProductGroupsResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\SitooClient
 * @author   OpenAPI Generator team
 ...
 */
class GetProductGroupsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getProductGroupsResponse';
    ...
    protected static $openAPITypes = [
        'totalcount' => 'int',
        'items' => '\Spy\SitooClient\Model\ProductgroupRead[]'
    ];
     ...
     * Sets items
     *
     * @param \Spy\SitooClient\Model\ProductgroupRead[] $items items
     *
     * @return self
     */

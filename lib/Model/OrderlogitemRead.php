...
/**
 * OrderlogitemRead Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderlogitemRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orderlogitem-read';
    ...
    {
        $this->setIfExists('datelog', $data, null);
    ...
    {
        return $this->container['datelog'];
    }

    /**
     * Sets datelog
     *
     * @param int|null $datelog Date and time of log entry.
     *
     * @return self
     */

...
/**
 * GetSalesTaxGroupsResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\SitooClient
 * @author   OpenAPI Generator team
 ...
 */
class GetSalesTaxGroupsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSalesTaxGroupsResponse';
    ...
    protected static $openAPITypes = [
        'totalcount' => 'int',
        'items' => '\Spy\SitooClient\Model\SalestaxgroupRead[]'
    ];
     ...
     * Sets items
     *
     * @param \Spy\SitooClient\Model\SalestaxgroupRead[] $items items
     *
     * @return self
     */

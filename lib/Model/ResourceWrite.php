...
/**
 * ResourceWrite Class Doc Comment
 *
 * @category Class
 ...
 */
class ResourceWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resource-write';
    ...
    */
     ...
     * Sets resourceid
     *
     * @param string $resourceid ID for the file as a relative URL (typically the filename).
     *
     * @return self
     */
     ...
     * Sets filedata
     *
     * @param string|null $filedata Image as a base64-encoded string
     *
     * @return self
     */

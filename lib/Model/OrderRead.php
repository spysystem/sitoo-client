 ...
 */
class OrderRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return OrderReadModelFields
      */
    public static function GetModelFields(): OrderReadModelFields
    {
        return new OrderReadModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return OrderReadModelAttributes
      */
    public static function GetModelAttributes(): OrderReadModelAttributes
    {
        return new OrderReadModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-read';
    ...
    protected static $openAPITypes = [
        ...
        'moneycheckoutNet' => 'string',
        'moneycheckoutVat' => 'string',
        'moneytotalGrossCheckout' => 'string',
        'moneydeliveryNet' => 'string',
        'moneydeliveryVat' => 'string',
        'moneytotalGrossDelivery' => 'string',
        'moneyfinalNet' => 'string',
        'moneyfinalVat' => 'string',
        'moneyfinalSalestax' => 'string',
        'moneytotalGrossRoundoff' => 'string',
        'moneytotalGrossAll' => 'string',
        'orderdate' => 'int',
        'orderstateid' => 'int',
        'paymentstateid' => 'int',
        'ordertypeid' => 'int',
        ...
        'datereserved' => 'int',
        'currencycode' => 'string',
        'additionaldata' => '\Spy\SitooClient\Model\OrderAdditionaldataRead',
        'orderitems' => '\Spy\SitooClient\Model\OrderitemRead[]',
        'payments' => '\Spy\SitooClient\Model\OrderpaymentRead[]',
        'reservedpayments' => '\Spy\SitooClient\Model\OrderreservedpaymentRead[]',
        'orderlogitems' => '\Spy\SitooClient\Model\OrderlogitemRead[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'moneytotalNet' => null,
        'moneytotalVat' => null,
        'moneycheckoutNet' => null,
        'moneycheckoutVat' => null,
        'moneytotalGrossCheckout' => null,
        'moneydeliveryNet' => null,
        'moneydeliveryVat' => null,
        'moneytotalGrossDelivery' => null,
        'moneyfinalNet' => null,
        'moneyfinalVat' => null,
        'moneyfinalSalestax' => null,
        'moneytotalGrossRoundoff' => null,
        'moneytotalGrossAll' => null,
        'orderdate' => null,
        'orderstateid' => null,
        'paymentstateid' => null,
        'ordertypeid' => null,
    ...
    protected static array $openAPINullables = [
		...
		'moneytotalNet' => false,
		'moneytotalVat' => false,
		'moneycheckoutNet' => false,
		'moneycheckoutVat' => false,
		'moneytotalGrossCheckout' => false,
		'moneydeliveryNet' => false,
		'moneydeliveryVat' => false,
		'moneytotalGrossDelivery' => false,
		'moneyfinalNet' => false,
		'moneyfinalVat' => false,
		'moneyfinalSalestax' => false,
		'moneytotalGrossRoundoff' => false,
		'moneytotalGrossAll' => false,
		'orderdate' => false,
		'orderstateid' => false,
    ...
    protected static $attributeMap = [
        ...
        'moneytotalNet' => 'moneytotal_net',
        'moneytotalVat' => 'moneytotal_vat',
        'moneycheckoutNet' => 'moneycheckout_net',
        'moneycheckoutVat' => 'moneycheckout_vat',
        'moneytotalGrossCheckout' => 'moneytotal_gross_checkout',
        'moneydeliveryNet' => 'moneydelivery_net',
        'moneydeliveryVat' => 'moneydelivery_vat',
        'moneytotalGrossDelivery' => 'moneytotal_gross_delivery',
        'moneyfinalNet' => 'moneyfinal_net',
        'moneyfinalVat' => 'moneyfinal_vat',
        'moneyfinalSalestax' => 'moneyfinal_salestax',
        'moneytotalGrossRoundoff' => 'moneytotal_gross_roundoff',
        'moneytotalGrossAll' => 'moneytotal_gross_all',
        'orderdate' => 'orderdate',
        'orderstateid' => 'orderstateid',
        'paymentstateid' => 'paymentstateid',
        'ordertypeid' => 'ordertypeid',
        'useridStaff' => 'userid_staff',
    ...
    protected static $setters = [
        ...
        'moneycheckoutNet' => 'setMoneycheckoutNet',
        'moneycheckoutVat' => 'setMoneycheckoutVat',
        'moneytotalGrossCheckout' => 'setMoneytotalGrossCheckout',
        'moneydeliveryNet' => 'setMoneydeliveryNet',
        'moneydeliveryVat' => 'setMoneydeliveryVat',
        'moneytotalGrossDelivery' => 'setMoneytotalGrossDelivery',
        'moneyfinalNet' => 'setMoneyfinalNet',
        'moneyfinalVat' => 'setMoneyfinalVat',
        'moneyfinalSalestax' => 'setMoneyfinalSalestax',
        'moneytotalGrossRoundoff' => 'setMoneytotalGrossRoundoff',
        'moneytotalGrossAll' => 'setMoneytotalGrossAll',
        'orderdate' => 'setOrderdate',
        'orderstateid' => 'setOrderstateid',
        'paymentstateid' => 'setPaymentstateid',
        'ordertypeid' => 'setOrdertypeid',
        'useridStaff' => 'setUseridStaff',
        ...
        'orderlogitems' => 'setOrderlogitems'
    ];
    ...
    protected static $getters = [
        ...
        'moneycheckoutNet' => 'getMoneycheckoutNet',
        'moneycheckoutVat' => 'getMoneycheckoutVat',
        'moneytotalGrossCheckout' => 'getMoneytotalGrossCheckout',
        'moneydeliveryNet' => 'getMoneydeliveryNet',
        'moneydeliveryVat' => 'getMoneydeliveryVat',
        'moneytotalGrossDelivery' => 'getMoneytotalGrossDelivery',
        'moneyfinalNet' => 'getMoneyfinalNet',
        'moneyfinalVat' => 'getMoneyfinalVat',
        'moneyfinalSalestax' => 'getMoneyfinalSalestax',
        'moneytotalGrossRoundoff' => 'getMoneytotalGrossRoundoff',
        'moneytotalGrossAll' => 'getMoneytotalGrossAll',
        'orderdate' => 'getOrderdate',
        'orderstateid' => 'getOrderstateid',
        'paymentstateid' => 'getPaymentstateid',
        'ordertypeid' => 'getOrdertypeid',
        'useridStaff' => 'getUseridStaff',
        ...
        'orderlogitems' => 'getOrderlogitems'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('moneycheckoutNet', $data ?? [], null);
        $this->setIfExists('moneycheckoutVat', $data ?? [], null);
        $this->setIfExists('moneytotalGrossCheckout', $data ?? [], null);
        $this->setIfExists('moneydeliveryNet', $data ?? [], null);
        $this->setIfExists('moneydeliveryVat', $data ?? [], null);
        $this->setIfExists('moneytotalGrossDelivery', $data ?? [], null);
        $this->setIfExists('moneyfinalNet', $data ?? [], null);
        $this->setIfExists('moneyfinalVat', $data ?? [], null);
        $this->setIfExists('moneyfinalSalestax', $data ?? [], null);
        ...
        $this->setIfExists('orderlogitems', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets orderid
     *
     * @param int|null $orderid The ID of the order. The orderid is unique for a system.
     *
     * @return self
     */
     ...
     * Sets eshopid
     *
     * @param int|null $eshopid The eshopid that this order belongs to.
     *
     * @return self
     */
     ...
     * Sets moneytotalNet
     *
     * @param string|null $moneytotalNet Total net value for items (no checkout or payment cost is included).
     *
     * @return self
     */
     ...
     * Sets moneytotalVat
     *
     * @param string|null $moneytotalVat Total vat value for items.
     *
     * @return self
     */
    ...
    /**
     * Gets moneycheckoutNet
     *
     * @return string|null
     */
    public function getMoneycheckoutNet()
    {
        return $this->container['moneycheckoutNet'];
    }

    /**
     * Sets moneycheckoutNet
     *
     * @param string|null $moneycheckoutNet Checkout cost net value.
     *
     * @return self
     */
    public function setMoneycheckoutNet($moneycheckoutNet)
    {

        if (is_null($moneycheckoutNet)) {
            throw new \InvalidArgumentException('non-nullable moneycheckoutNet cannot be null');
        }

        $this->container['moneycheckoutNet'] = $moneycheckoutNet;

        return $this;
    }

    /**
     * Gets moneycheckoutVat
     *
     * @return string|null
     */
    public function getMoneycheckoutVat()
    {
        return $this->container['moneycheckoutVat'];
    }

    /**
     * Sets moneycheckoutVat
     *
     * @param string|null $moneycheckoutVat Checkout cost vat value.
     *
     * @return self
     */
    public function setMoneycheckoutVat($moneycheckoutVat)
    {

        if (is_null($moneycheckoutVat)) {
            throw new \InvalidArgumentException('non-nullable moneycheckoutVat cannot be null');
        }

        $this->container['moneycheckoutVat'] = $moneycheckoutVat;

        return $this;
    }

    /**
     * Gets moneytotalGrossCheckout
     *
     * @return string|null
     */
    public function getMoneytotalGrossCheckout()
    {
        return $this->container['moneytotalGrossCheckout'];
    }

    /**
     * Sets moneytotalGrossCheckout
     *
     * @param string|null $moneytotalGrossCheckout Total checkout value (ie. checkout_net + checkout_vat).
     *
     * @return self
     */
    public function setMoneytotalGrossCheckout($moneytotalGrossCheckout)
    {

        if (is_null($moneytotalGrossCheckout)) {
            throw new \InvalidArgumentException('non-nullable moneytotalGrossCheckout cannot be null');
        }

        $this->container['moneytotalGrossCheckout'] = $moneytotalGrossCheckout;

        return $this;
    }

    /**
     * Gets moneydeliveryNet
     *
     * @return string|null
     */
    public function getMoneydeliveryNet()
    {
        return $this->container['moneydeliveryNet'];
    }

    /**
     * Sets moneydeliveryNet
     *
     * @param string|null $moneydeliveryNet Delivery cost net value.
     *
     * @return self
     */
    public function setMoneydeliveryNet($moneydeliveryNet)
    {

        if (is_null($moneydeliveryNet)) {
            throw new \InvalidArgumentException('non-nullable moneydeliveryNet cannot be null');
        }

        $this->container['moneydeliveryNet'] = $moneydeliveryNet;

        return $this;
    }

    /**
     * Gets moneydeliveryVat
     *
     * @return string|null
     */
    public function getMoneydeliveryVat()
    {
        return $this->container['moneydeliveryVat'];
    }

    /**
     * Sets moneydeliveryVat
     *
     * @param string|null $moneydeliveryVat Delivery cost vat value.
     *
     * @return self
     */
    public function setMoneydeliveryVat($moneydeliveryVat)
    {

        if (is_null($moneydeliveryVat)) {
            throw new \InvalidArgumentException('non-nullable moneydeliveryVat cannot be null');
        }

        $this->container['moneydeliveryVat'] = $moneydeliveryVat;

        return $this;
    }

    /**
     * Gets moneytotalGrossDelivery
     *
     * @return string|null
     */
    public function getMoneytotalGrossDelivery()
    {
        return $this->container['moneytotalGrossDelivery'];
    }

    /**
     * Sets moneytotalGrossDelivery
     *
     * @param string|null $moneytotalGrossDelivery Total delivery value (ie. delivery_net + delivery_vat).
     *
     * @return self
     */
    public function setMoneytotalGrossDelivery($moneytotalGrossDelivery)
    {

        if (is_null($moneytotalGrossDelivery)) {
            throw new \InvalidArgumentException('non-nullable moneytotalGrossDelivery cannot be null');
        }

        $this->container['moneytotalGrossDelivery'] = $moneytotalGrossDelivery;
     ...
     * @return string|null
     */
    public function getMoneyfinalNet()
    {
        return $this->container['moneyfinalNet'];
    }

    /**
     * Sets moneyfinalNet
     *
     * @param string|null $moneyfinalNet Final net value (ie. total_net + checkout_net + delivery_net).
     *
     * @return self
     */
    public function setMoneyfinalNet($moneyfinalNet)
    {

        if (is_null($moneyfinalNet)) {
            throw new \InvalidArgumentException('non-nullable moneyfinalNet cannot be null');
        }

        $this->container['moneyfinalNet'] = $moneyfinalNet;
     ...
     * @return string|null
     */
    public function getMoneyfinalVat()
    {
        return $this->container['moneyfinalVat'];
    }

    /**
     * Sets moneyfinalVat
     *
     * @param string|null $moneyfinalVat Final vat value (ie. total_vat + checkout_vat + delivery_vat).
     *
     * @return self
     */
    public function setMoneyfinalVat($moneyfinalVat)
    {

        if (is_null($moneyfinalVat)) {
            throw new \InvalidArgumentException('non-nullable moneyfinalVat cannot be null');
        }

        $this->container['moneyfinalVat'] = $moneyfinalVat;

        return $this;
    }

    /**
     * Gets moneyfinalSalestax
     *
     * @return string|null
     */
    public function getMoneyfinalSalestax()
    {
        return $this->container['moneyfinalSalestax'];
    }

    /**
     * Sets moneyfinalSalestax
     *
     * @param string|null $moneyfinalSalestax Collected sales tax.
     *
     * @return self
     */
    public function setMoneyfinalSalestax($moneyfinalSalestax)
    {

        if (is_null($moneyfinalSalestax)) {
            throw new \InvalidArgumentException('non-nullable moneyfinalSalestax cannot be null');
        }

        $this->container['moneyfinalSalestax'] = $moneyfinalSalestax;

        return $this;
    }

    /**
     * Gets moneytotalGrossRoundoff
     *
     * @return string|null
     */
    public function getMoneytotalGrossRoundoff()
    {
        return $this->container['moneytotalGrossRoundoff'];
    }

    /**
     * Sets moneytotalGrossRoundoff
     *
     * @param string|null $moneytotalGrossRoundoff Roundoff value if applicable.
     *
     * @return self
     */
    public function setMoneytotalGrossRoundoff($moneytotalGrossRoundoff)
    {

        if (is_null($moneytotalGrossRoundoff)) {
            throw new \InvalidArgumentException('non-nullable moneytotalGrossRoundoff cannot be null');
        }

        $this->container['moneytotalGrossRoundoff'] = $moneytotalGrossRoundoff;

        return $this;
    }

    /**
     * Gets moneytotalGrossAll
     *
     * @return string|null
     */
    public function getMoneytotalGrossAll()
    {
        return $this->container['moneytotalGrossAll'];
    }

    /**
     * Sets moneytotalGrossAll
     *
     * @param string|null $moneytotalGrossAll Grand total. The sum to pay.
     *
     * @return self
     */
    public function setMoneytotalGrossAll($moneytotalGrossAll)
    {

        if (is_null($moneytotalGrossAll)) {
            throw new \InvalidArgumentException('non-nullable moneytotalGrossAll cannot be null');
        }

        $this->container['moneytotalGrossAll'] = $moneytotalGrossAll;
     ...
     * @return string|null
     */
    public function getUseridStaff()
    {
        return $this->container['useridStaff'];
    }

    /**
     * Sets useridStaff
     *
     * @param string|null $useridStaff User ID for the staff that is responsible for the order and should get credit for it.
     *
     * @return self
     */
    public function setUseridStaff($useridStaff)
    {

        if (is_null($useridStaff)) {
            throw new \InvalidArgumentException('non-nullable useridStaff cannot be null');
        }

        $this->container['useridStaff'] = $useridStaff;
     ...
     * Sets registerid
     *
     * @param string|null $registerid Register ID of the POS client or null if Webshop order.
     *
     * @return self
     */
     ...
     * Gets additionaldata
     *
     * @return \Spy\SitooClient\Model\OrderAdditionaldataRead|null
     */
     ...
     * Sets additionaldata
     *
     * @param \Spy\SitooClient\Model\OrderAdditionaldataRead|null $additionaldata additionaldata
     *
     * @return self
     */
     ...
     * Gets orderitems
     *
     * @return \Spy\SitooClient\Model\OrderitemRead[]|null
     */
     ...
     * Sets orderitems
     *
     * @param \Spy\SitooClient\Model\OrderitemRead[]|null $orderitems The order items for this order. An array of orderitem.
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \Spy\SitooClient\Model\OrderpaymentRead[]|null
     */
     ...
     * Sets payments
     *
     * @param \Spy\SitooClient\Model\OrderpaymentRead[]|null $payments The payments for this order. An array of orderpayment.
     *
     * @return self
     */
     ...
     *
     * @return \Spy\SitooClient\Model\OrderreservedpaymentRead[]|null
     */
     ...
     *
     * @param \Spy\SitooClient\Model\OrderreservedpaymentRead[]|null $reservedpayments The reserved payments for this order. An array of orderreservedpayment.
     *
     * @return self
     */
     ...
     * Gets orderlogitems
     *
     * @return \Spy\SitooClient\Model\OrderlogitemRead[]|null
     */
    public function getOrderlogitems()
    {
        return $this->container['orderlogitems'];
    }

    /**
     * Sets orderlogitems
     *
     * @param \Spy\SitooClient\Model\OrderlogitemRead[]|null $orderlogitems The log items for this order. An array of orderlogitem.
     *
     * @return self
     */
    public function setOrderlogitems($orderlogitems)
    {

        if (is_null($orderlogitems)) {
            throw new \InvalidArgumentException('non-nullable orderlogitems cannot be null');
        }

        $this->container['orderlogitems'] = $orderlogitems;

...
/**
 * GetZReportsResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\SitooClient
 * @author   OpenAPI Generator team
 ...
 */
class GetZReportsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getZReportsResponse';
    ...
    protected static $openAPITypes = [
        'totalcount' => 'int',
        'items' => '\Spy\SitooClient\Model\PoszreportRead[]'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \Spy\SitooClient\Model\PoszreportRead[] $items items
     *
     * @return self
     */

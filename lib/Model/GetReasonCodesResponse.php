...
/**
 * GetReasonCodesResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\SitooClient
 * @author   OpenAPI Generator team
 ...
 */
class GetReasonCodesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getReasonCodesResponse';
    ...
    protected static $openAPITypes = [
        'totalcount' => 'int',
        'items' => '\Spy\SitooClient\Model\ReasoncodeRead[]'
    ];
     ...
     * Sets items
     *
     * @param \Spy\SitooClient\Model\ReasoncodeRead[] $items items
     *
     * @return self
     */

...
/**
 * OrderReadModelAttributes Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class OrderReadModelAttributes
{
    ...
    public string $strMoneycheckoutNet = 'moneycheckoutNet';
    public string $strMoneycheckoutVat = 'moneycheckoutVat';
    public string $strMoneytotalGrossCheckout = 'moneytotalGrossCheckout';
    public string $strMoneydeliveryNet = 'moneydeliveryNet';
    public string $strMoneydeliveryVat = 'moneydeliveryVat';
    public string $strMoneytotalGrossDelivery = 'moneytotalGrossDelivery';
    public string $strMoneyfinalNet = 'moneyfinalNet';
    public string $strMoneyfinalVat = 'moneyfinalVat';
    public string $strMoneyfinalSalestax = 'moneyfinalSalestax';
    public string $strMoneytotalGrossRoundoff = 'moneytotalGrossRoundoff';
    public string $strMoneytotalGrossAll = 'moneytotalGrossAll';
    ...
    public string $strUseridStaff = 'useridStaff';

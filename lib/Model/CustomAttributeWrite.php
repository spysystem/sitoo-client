...
/**
 * CustomAttributeWrite Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomAttributeWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomAttribute-write';
    ...
    */
    ...
    public function setEnums($enums)
    {
        ...
        if (is_null($enums)) {
            ...
            $index = array_search('enums', $nullablesSetToNull);
            if ($index !== FALSE) {

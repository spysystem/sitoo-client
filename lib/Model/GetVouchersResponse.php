...
/**
 * GetVouchersResponse Class Doc Comment
 *
 * @category Class
 * @package  Spy\SitooClient
 * @author   OpenAPI Generator team
 ...
 */
class GetVouchersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getVouchersResponse';
    ...
    protected static $openAPITypes = [
        'totalcount' => 'int',
        'items' => '\Spy\SitooClient\Model\VoucherRead[]'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \Spy\SitooClient\Model\VoucherRead[] $items items
     *
     * @return self
     */

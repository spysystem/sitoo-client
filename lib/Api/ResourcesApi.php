...
class ResourcesApi
{
     ...
     */
    public function getResources($siteid, $start = null, $num = null, $fields = null, string $contentType = self::contentTypes['getResources'][0])
    {
        list($response) = $this->getResourcesWithHttpInfo($siteid, $start, $num, $fields, $contentType);
        return $response;
    }
     ...
     */
    public function getResourcesWithHttpInfo($siteid, $start = null, $num = null, $fields = null, string $contentType = self::contentTypes['getResources'][0])
    {
        $request = $this->getResourcesRequest($siteid, $start, $num, $fields, $contentType);
     ...
     */
    public function getResourcesAsync($siteid, $start = null, $num = null, $fields = null, string $contentType = self::contentTypes['getResources'][0])
    {
        return $this->getResourcesAsyncWithHttpInfo($siteid, $start, $num, $fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResourcesAsyncWithHttpInfo($siteid, $start = null, $num = null, $fields = null, string $contentType = self::contentTypes['getResources'][0])
    {
        $returnType = '\Spy\SitooClient\Model\GetResourcesResponse';
        $request = $this->getResourcesRequest($siteid, $start, $num, $fields, $contentType);
     ...
     */
    public function getResourcesRequest($siteid, $start = null, $num = null, $fields = null, string $contentType = self::contentTypes['getResources'][0])
    {

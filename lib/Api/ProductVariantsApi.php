...
class ProductVariantsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProductVariants'] to see the possible values for this operation
     *
     ...
     */
    public function getProductVariants($siteid, $productid, string $contentType = self::contentTypes['getProductVariants'][0])
    {
        list($response) = $this->getProductVariantsWithHttpInfo($siteid, $productid, $contentType);
        return $response;
    }
     ...
     */
    public function getProductVariantsWithHttpInfo($siteid, $productid, string $contentType = self::contentTypes['getProductVariants'][0])
    {
        $request = $this->getProductVariantsRequest($siteid, $productid, $contentType);
     ...
     */
    public function getProductVariantsAsync($siteid, $productid, string $contentType = self::contentTypes['getProductVariants'][0])
    {
        return $this->getProductVariantsAsyncWithHttpInfo($siteid, $productid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductVariantsAsyncWithHttpInfo($siteid, $productid, string $contentType = self::contentTypes['getProductVariants'][0])
    {
        $returnType = '\Spy\SitooClient\Model\ProductvariantsRead';
        $request = $this->getProductVariantsRequest($siteid, $productid, $contentType);
     ...
     */
    public function getProductVariantsRequest($siteid, $productid, string $contentType = self::contentTypes['getProductVariants'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setProductVariants'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function setProductVariants($siteid, $productid, $productvariantsWrite, string $contentType = self::contentTypes['setProductVariants'][0])
    {
        list($response) = $this->setProductVariantsWithHttpInfo($siteid, $productid, $productvariantsWrite, $contentType);
        return $response;
    }
     ...
     */
    public function setProductVariantsWithHttpInfo($siteid, $productid, $productvariantsWrite, string $contentType = self::contentTypes['setProductVariants'][0])
    {
        $request = $this->setProductVariantsRequest($siteid, $productid, $productvariantsWrite, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setProductVariantsAsync($siteid, $productid, $productvariantsWrite, string $contentType = self::contentTypes['setProductVariants'][0])
    {
        return $this->setProductVariantsAsyncWithHttpInfo($siteid, $productid, $productvariantsWrite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setProductVariantsAsyncWithHttpInfo($siteid, $productid, $productvariantsWrite, string $contentType = self::contentTypes['setProductVariants'][0])
    {
        $returnType = 'bool';
        $request = $this->setProductVariantsRequest($siteid, $productid, $productvariantsWrite, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setProductVariantsRequest($siteid, $productid, $productvariantsWrite, string $contentType = self::contentTypes['setProductVariants'][0])
    {
        ...
        if (isset($productvariantsWrite)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($productvariantsWrite));
            } else {

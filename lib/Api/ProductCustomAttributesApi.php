...
class ProductCustomAttributesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addCustomAttribute'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function addCustomAttribute($siteid, $customAttributeWrite, string $contentType = self::contentTypes['addCustomAttribute'][0])
    {
        $this->addCustomAttributeWithHttpInfo($siteid, $customAttributeWrite, $contentType);
    }
     ...
     */
    public function addCustomAttributeWithHttpInfo($siteid, $customAttributeWrite, string $contentType = self::contentTypes['addCustomAttribute'][0])
    {
        $request = $this->addCustomAttributeRequest($siteid, $customAttributeWrite, $contentType);
     ...
     */
    public function addCustomAttributeAsync($siteid, $customAttributeWrite, string $contentType = self::contentTypes['addCustomAttribute'][0])
    {
        return $this->addCustomAttributeAsyncWithHttpInfo($siteid, $customAttributeWrite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addCustomAttributeAsyncWithHttpInfo($siteid, $customAttributeWrite, string $contentType = self::contentTypes['addCustomAttribute'][0])
    {
        $returnType = '';
        $request = $this->addCustomAttributeRequest($siteid, $customAttributeWrite, $contentType);
     ...
     */
    public function addCustomAttributeRequest($siteid, $customAttributeWrite, string $contentType = self::contentTypes['addCustomAttribute'][0])
    {
        ...
        if (isset($customAttributeWrite)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($customAttributeWrite));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteCustomAttribute'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteCustomAttribute($siteid, $attributeid, string $contentType = self::contentTypes['deleteCustomAttribute'][0])
    {
        $this->deleteCustomAttributeWithHttpInfo($siteid, $attributeid, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteCustomAttributeWithHttpInfo($siteid, $attributeid, string $contentType = self::contentTypes['deleteCustomAttribute'][0])
    {
        $request = $this->deleteCustomAttributeRequest($siteid, $attributeid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCustomAttributeAsync($siteid, $attributeid, string $contentType = self::contentTypes['deleteCustomAttribute'][0])
    {
        return $this->deleteCustomAttributeAsyncWithHttpInfo($siteid, $attributeid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCustomAttributeAsyncWithHttpInfo($siteid, $attributeid, string $contentType = self::contentTypes['deleteCustomAttribute'][0])
    {
        $returnType = '';
        $request = $this->deleteCustomAttributeRequest($siteid, $attributeid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteCustomAttributeRequest($siteid, $attributeid, string $contentType = self::contentTypes['deleteCustomAttribute'][0])
    {
     ...
     * @param  int $siteid siteid (required)
     * @param  string $attributeid attributeid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCustomAttribute'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomAttributeAsync($siteid, $attributeid, string $contentType = self::contentTypes['getCustomAttribute'][0])
    {
        return $this->getCustomAttributeAsyncWithHttpInfo($siteid, $attributeid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomAttributeRequest($siteid, $attributeid, string $contentType = self::contentTypes['getCustomAttribute'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCustomAttributes'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomAttributesAsync($siteid, $start = null, $num = null, string $contentType = self::contentTypes['getCustomAttributes'][0])
    {
        return $this->getCustomAttributesAsyncWithHttpInfo($siteid, $start, $num, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomAttributesRequest($siteid, $start = null, $num = null, string $contentType = self::contentTypes['getCustomAttributes'][0])
    {
     ...
     * @param  string $attributeid attributeid (required)
     * @param  \Spy\SitooClient\Model\CustomAttributeWrite $customAttributeWrite customAttributeWrite (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateCustomAttribute'] to see the possible values for this operation
     *
     * @throws \Spy\SitooClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateCustomAttribute($siteid, $attributeid, $customAttributeWrite, string $contentType = self::contentTypes['updateCustomAttribute'][0])
    {
        $this->updateCustomAttributeWithHttpInfo($siteid, $attributeid, $customAttributeWrite, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCustomAttributeWithHttpInfo($siteid, $attributeid, $customAttributeWrite, string $contentType = self::contentTypes['updateCustomAttribute'][0])
    {
        $request = $this->updateCustomAttributeRequest($siteid, $attributeid, $customAttributeWrite, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomAttributeAsync($siteid, $attributeid, $customAttributeWrite, string $contentType = self::contentTypes['updateCustomAttribute'][0])
    {
        return $this->updateCustomAttributeAsyncWithHttpInfo($siteid, $attributeid, $customAttributeWrite, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomAttributeAsyncWithHttpInfo($siteid, $attributeid, $customAttributeWrite, string $contentType = self::contentTypes['updateCustomAttribute'][0])
    {
        $returnType = '';
        $request = $this->updateCustomAttributeRequest($siteid, $attributeid, $customAttributeWrite, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCustomAttributeRequest($siteid, $attributeid, $customAttributeWrite, string $contentType = self::contentTypes['updateCustomAttribute'][0])
    {

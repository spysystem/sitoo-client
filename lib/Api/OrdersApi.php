...
class OrdersApi
{
    ...
    public function addOrderDeliveryRequest($siteid, $orderid, $orderdeliveryWrite, $ignorestock = null)
    {
        ...
        // query params
        if (is_array($ignorestock)) {
            $ignorestock = ObjectSerializer::serializeCollection($ignorestock, '', true);
        }
        if ($ignorestock !== null) {
            $queryParams['ignorestock'] = $ignorestock;
        }
    ...
    public function getAllOrdersRequest($eshopid = null, $externalid = null, $orderid = null, $orderidfrom = null, $orderidto = null, $orderdatefrom = null, $orderdateto = null, $orderstate = null, $paymentstate = null, $ordertype = null, $email = null, $start = null, $num = null, $sort = null, $fields = null)
    {
        ...
        // query params
        if (is_array($orderidfrom)) {
            $orderidfrom = ObjectSerializer::serializeCollection($orderidfrom, '', true);
        }
        if ($orderidfrom !== null) {
            $queryParams['orderidfrom'] = $orderidfrom;
        }
        // query params
        if (is_array($orderidto)) {
            $orderidto = ObjectSerializer::serializeCollection($orderidto, '', true);
        }
        if ($orderidto !== null) {
            $queryParams['orderidto'] = $orderidto;
        }
        // query params
        if (is_array($orderdatefrom)) {
            $orderdatefrom = ObjectSerializer::serializeCollection($orderdatefrom, '', true);
        }
        if ($orderdatefrom !== null) {
            $queryParams['orderdatefrom'] = $orderdatefrom;
        }
        // query params
        if (is_array($orderdateto)) {
            $orderdateto = ObjectSerializer::serializeCollection($orderdateto, '', true);
        }
        if ($orderdateto !== null) {

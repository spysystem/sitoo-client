...
class ShipmentsApi
{
    ...
    public function getShipmentsRequest($shipmentid = null, $senderWarehouseid = null, $receiverWarehouseid = null, $archived = null, $start = null, $num = null, $fields = null)
    {
        ...
        // query params
        if (is_array($senderWarehouseid)) {
            $senderWarehouseid = ObjectSerializer::serializeCollection($senderWarehouseid, '', true);
        }
        if ($senderWarehouseid !== null) {
            $queryParams['sender_warehouseid'] = $senderWarehouseid;
        }
        // query params
        if (is_array($receiverWarehouseid)) {
            $receiverWarehouseid = ObjectSerializer::serializeCollection($receiverWarehouseid, '', true);
        }
        if ($receiverWarehouseid !== null) {
            $queryParams['receiver_warehouseid'] = $receiverWarehouseid;
        }
        // query params
